...
struct AutomationGuideView: View {
    private let steps: [(String, String)] = [
        ...
        ("6", "חשוב: הקישו על השדה «פרטי העסקה», ומעל המקלדת בחרו «בחירת משתנה» ואז «קלט של קיצור» (באנגלית: Shortcut Input). בלי זה הטלפון יבקש מכם להקליד כל קנייה"),
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Text("שימו לב במיוחד לשלב 6. הוא הקצר ביותר וגם היחיד שאם מדלגים עליו, "
                     + "האוטומציה תיראה תקינה אבל תבקש להקליד כל קנייה ידנית.")
                    .font(.footnote)
                    .foregroundStyle(Brand.mutedText)
